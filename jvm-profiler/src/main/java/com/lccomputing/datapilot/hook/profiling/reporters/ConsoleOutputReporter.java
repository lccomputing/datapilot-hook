...
public class ConsoleOutputReporter extends Reporter {
    public ConsoleOutputReporter(Arguments arguments, ExecutorInfo executor) {
        super(arguments, executor);
    }

    @Override
    public void report() throws IOException {
//        System.err.println("ConsoleOutputReporter: " + getMetrics());
    }
}
